...
import com.example.demo.dao.AgDataMakeMoney50Repository;
import com.example.demo.model.AgDataMakeMoney50;
import com.example.demo.model.AgDataMakeMoney50;
...
public class AgData50Service {
    ...
    @Transactional
    public void save(AgDataMakeMoney50 agData) {
        agDataMakeMoney50Repository.save(agData);
    }

    public List<AgDataMakeMoney50> getAll() {
        return (List<AgDataMakeMoney50>) agDataMakeMoney50Repository.findAll();
    }

    public long count() {
        return agDataMakeMoney50Repository.count();
    }

    public AgDataMakeMoney50 findOne(Integer id) {
        return agDataMakeMoney50Repository.findOne(id);
    }

    @Transactional
    public void save(List<AgDataMakeMoney50> agDataMakeMoney50List) {
        agDataMakeMoney50Repository.save(agDataMakeMoney50List);
    ...
    public void test50Data() {
        ...
        int number = 0;
        int makeMoney = 0;
        List<AgDataMakeMoney50> moneyDayBig = new ArrayList<>();
        List<AgDataMakeMoney50> moneyByDb = getAll();
        for (int i = 0; i < 2500; i++) {
            AgDataMakeMoney50 agDataMakeMoney = moneyByDb.get(i);
...
//        System.out.println("赚钱大于30小于5000的天数：" + daySum+";分别是："+moneyDayBig.toString());
    ...
    private void stepNumber(AgDataMakeMoney50 AgDataMakeMoney50) {
        int day = AgDataMakeMoney50.getDayAll();
        if (day <= 10) {
            day10++;
            return;
        }
