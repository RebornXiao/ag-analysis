...
import com.example.demo.dao.AgDataMakeMoney200Repository;
import com.example.demo.model.AgDataMakeMoney200;
...
public class AgData200Service {
    ...
    @Transactional
    public void save(AgDataMakeMoney200 agData) {
        agDataMakeMoney200Repository.save(agData);
    }

    public List<AgDataMakeMoney200> getAll() {
        return (List<AgDataMakeMoney200>) agDataMakeMoney200Repository.findAll();
    }

    public long count() {
        return agDataMakeMoney200Repository.count();
    }

    public AgDataMakeMoney200 findOne(Integer id) {
        return agDataMakeMoney200Repository.findOne(id);
    }

    @Transactional
    public void save(List<AgDataMakeMoney200> agDataMakeMoney200List) {
        agDataMakeMoney200Repository.save(agDataMakeMoney200List);
    }

    public void test200Data() {
        int day = 0;
        int price = 0;
        int daySum = 0;
        int moneyDay = 0;
        ...
        int number = 0;
        int makeMoney = 0;
        List<AgDataMakeMoney200> moneyDayBig = new ArrayList<>();
        List<AgDataMakeMoney200> moneyByDb = getAll();
        for (int i = 0; i < 2500; i++) {
            AgDataMakeMoney200 agDataMakeMoney = moneyByDb.get(i);
...
//        System.out.println("赚钱大于30小于5000的天数：" + daySum+";分别是："+moneyDayBig.toString());
    ...
    private void stepNumber(AgDataMakeMoney200 agDataMakeMoney200) {
        int day = agDataMakeMoney200.getDayAll();
        if (day <= 10) {
            day10++;
            return;
        }
